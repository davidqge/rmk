...
cargo run --release  
    ...
    Finished `release` profile [optimized + debuginfo] target(s) in 51.39s
     Running `espflash flash --monitor --log-format defmt target/riscv32imc-esp-espidf/release/rmk-esp32c6`
...
# Check all segments
espsegs target/riscv32imc-esp-espidf/release/rmk-esp32c6 --chip esp32c6
```